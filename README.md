...
This project contains 4 different labels, these are 
...
After an epoch of training, as you can see we got reasonable accuracy.

![training](https://user-images.githubusercontent.com/30235603/104920135-a4844e00-5997-11eb-8c54-df0c9c1546da.png)


I can make the model better by increasing the no. of epochs(the more the epochs, the better the accuracy). Also, when going for higher no. of ephocs, make sure your PC has enough space and RAM. 
